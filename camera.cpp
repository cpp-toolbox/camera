 ...
 */
void Camera::update_look_direction(double change_in_yaw_angle,
  ...
  this->look_direction =
      Camera::yaw_pitch_angles_to_vector(this->yaw_angle, this->pitch_angle);
 ...
 *
 */
glm::vec3 Camera::input_snapshot_to_input_direction(bool forward_pressed,
  ...
  glm::vec3 xz_player_look_direction =
      glm::vec3(this->look_direction.x, 0.0f, this->look_direction.z);
  ...
  glm::vec3 forward_input_component =
      forward_component * xz_player_look_direction;
  glm::vec3 strafe_direction =
      glm::cross(xz_player_look_direction, this->up_direction);
